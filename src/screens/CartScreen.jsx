                    ...
                    <Container>       
                        <Row className="justify-content-start align-items-center">
                            ...
                            <Col sm={6}>
                                ...
                                <Card.Subtitle>{product.tag.sellerid},{product.tag.address} </Card.Subtitle>
                                <div className="description">{product.description}</div>
                            </Col>

                            <Col sm={3}>
                                    <button className="add-subtract">
                                        <i className="fa fa-minus" onClick={()=>{count!=1?setCount(count--):setCount(1)}}></i>
                                    </button>
                                    <text className="count-product">{count}</text>
                                    <button className="add-subtract">
                                        <i className="fa fa-plus" onClick={()=>{setCount(count++)}}></i>
                                    </button>
                            </Col>
